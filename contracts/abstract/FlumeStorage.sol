...
import {Range, Rebalance, InitializePayload} from "../structs/SFlume.sol";
import {hundredPercent} from "../constants/CFlume.sol";

/// @title FlumeStorage base contract containing all Flume storage variables.
// solhint-disable-next-line max-states-count
abstract contract FlumeStorage is
    OwnableUpgradeable,
    ERC20Upgradeable,
    ReentrancyGuardUpgradeable
{
