...
import {IFlumeResolver} from "./interfaces/IFlumeResolver.sol";
import {
    IUniswapV3Factory
...
import {hundredPercent} from "./constants/CFlume.sol";

/// @title FlumeResolver helpers that resolve / compute payloads for Flume calls
contract FlumeResolver is IFlumeResolver {
    ...
    /// @param vaultV2_ Flume vault.
    /// @return rebalanceParams payload to send to rebalance
    /// function on Flume contract.
