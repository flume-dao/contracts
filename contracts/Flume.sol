...
import {
    ...
    Range,
    Rebalance
} from "./abstract/FlumeStorage.sol";
import {FullMath} from "@arrakisfi/v3-lib-0.8/contracts/LiquidityAmounts.sol";
import {Withdraw, UnderlyingPayload} from "./structs/SFlume.sol";
import {Position} from "./libraries/Position.sol";
import {Pool} from "./libraries/Pool.sol";
import {Underlying as UnderlyingHelper} from "./libraries/Underlying.sol";
import {SafeCast} from "@openzeppelin/contracts/utils/math/SafeCast.sol";

/// @title Flume LP vault version 2
...
/// @author Flume
/// @dev DO NOT ADD STATE VARIABLES - APPEND THEM TO FlumeStorage
contract Flume is IUniswapV3MintCallback, FlumeStorage {
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;

    // solhint-disable-next-line no-empty-blocks
    constructor(IUniswapV3Factory factory_) FlumeStorage(factory_) {}
    ...
    /// @notice mint Flume shares by depositing underlying
    /// @param mintAmount_ represent the amount of Flume shares to mint.
    /// @param receiver_ address that will receive Flume shares.
    ...
    /// @notice burn Flume shares and withdraw underlying.
    ...
    /// @notice rebalance Flume vault's UniswapV3 positions
