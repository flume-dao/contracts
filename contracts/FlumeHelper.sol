...
import {IFlumeHelper} from "./interfaces/IFlumeHelper.sol";
...
/// @title FlumeHelper helpers for querying common info about Flume vaults
contract FlumeHelper is IFlumeHelper {
    ...
    /// @param vault_ Flume vault to get underlying info about.
        ...
        returns (UnderlyingOutput memory underlying)
    {
        ...
        underlying.leftOver0 =
            ...
            IFlume(underlyingPayload.self).managerBalance0();
        underlying.leftOver1 =
            IERC20(underlyingPayload.token1).balanceOf(underlyingPayload.self) -
            IFlume(underlyingPayload.self).managerBalance1();
    }
    ...
    /// @param vault_ Flume vault to get liquidity in ranges for
    ...
    /// @param vaultV2_ address of Flume vault.
