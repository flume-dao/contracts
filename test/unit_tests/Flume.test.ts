...
import { Flume, IUniswapV3Factory } from "../../typechain";
import { getAddresses, Addresses } from "../../src/addresses";
const { ethers, deployments } = hre;

describe("Flume functions unit test", function () {
  this.timeout(0);
  ...
  before("Setting up for Flume function test", async function () {
    ...
    arrakisV2 = await ethers.getContract("Flume", arrakisTreasury);
  });
